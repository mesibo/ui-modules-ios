...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _videoIcon.image = [ImagePickerUtils imageNamed:@"GMVideoIcon"];
        ...
        [_selectedButton setImage:[ImagePickerUtils imageNamed:@"GMSelected"] forState:UIControlStateSelected];
