...
- (void)viewDidLoad
{
    ...
    statusBarView.backgroundColor  =  [UIColor getColor:TOOLBAR_COLOR];
    ...
    /*
    NSString *cancelTitle = self.picker.customCancelButtonTitle ? self.picker.customCancelButtonTitle : NSLocalizedStringFromTableInBundle(@"picker.navigation.cancel-button",  @"GMImagePicker", [self getBundle], @"Cancel");
    ...
    [button addTarget:self.picker action:@selector(dismiss:)forControlEvents:UIControlEventTouchUpInside];
    ...
    if (self.picker.allowsMultipleSelection) {
        NSString *doneTitle = self.picker.customDoneButtonTitle ? self.picker.customDoneButtonTitle : NSLocalizedStringFromTableInBundle(@"picker.navigation.done-button",  @"GMImagePicker", [ImagePickerUtils getBundle], @"Done");
    ...
    self.collectionsLocalizedTitles = @[NSLocalizedStringFromTableInBundle(@"picker.table.user-albums-header",  @"GMImagePicker", [ImagePickerUtils getBundle], @"Albums"), NSLocalizedStringFromTableInBundle(@"picker.table.smart-albums-header",  @"GMImagePicker", [ImagePickerUtils getBundle], @"Smart Albums")];
...
-(void)updateFetchResults
{
    ...
    NSMutableArray *allFetchResultLabel = [[NSMutableArray alloc] init];
    {
        ...
        [allFetchResultLabel addObject:NSLocalizedStringFromTableInBundle(@"picker.table.all-photos-label",  @"GMImagePicker", [ImagePickerUtils getBundle], @"All photos")];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([assetsFetchResult count] > 0) {
        ...
        cell.imageView3.image = [ImagePickerUtils imageNamed:@"GMEmptyFolder"];
        cell.imageView2.image = [ImagePickerUtils imageNamed:@"GMEmptyFolder"];
        cell.imageView1.image = [ImagePickerUtils imageNamed:@"GMEmptyFolder"];
    }
