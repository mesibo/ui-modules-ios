    ...
    if (!self.allowsMultipleSelection) {
        if (self.confirmSingleSelection) {
            ...
            UIAlertAction* defaultAction = [UIAlertAction
                                            actionWithTitle:[NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"picker.action.no",  @"GMImagePicker", [NSBundle bundleForClass:GMImagePickerController.class],  @"No")] style:UIAlertActionStyleDefault
            ...
            UIAlertAction* okAction = [UIAlertAction
                                            actionWithTitle:[NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"picker.action.yes",  @"GMImagePicker", [NSBundle bundleForClass:GMImagePickerController.class],  @"Yes")] style:UIAlertActionStyleDefault
                                            handler:^(UIAlertAction * action) {
...
- (void)cameraButtonPressed:(UIBarButtonItem *)button
{
    if (![UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        ...
        [UIAlerts showDialogue:@"Sorry, this device does not have a camera." withTitle:@"No Camera!"];
...
{
    if (error) {
                [UIAlerts showDialogue:@"Sorry, unable to save the new image!" withTitle:@"Image Not Saved"];
    }
